...
class RankChartNew extends StatelessWidget {
  const RankChartNew({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    color.add(Colors.orange[500]!.withOpacity(0.5));
    color.add(Colors.orange[700]!.withOpacity(0.6));
    color.add(Colors.orange[900]!.withOpacity(0.7));
