...
class QuizServiceNew extends StatefulWidget {
  const QuizServiceNew({Key? key}) : super(key: key);

  @override
  State<QuizServiceNew> createState() => _QuizServiceState();
}

class _QuizServiceState extends State<QuizServiceNew> {
  late Timer timer;
